...
; CHECK-MOPS-NEXT:    adrp x16, .LCPI0_0
; CHECK-MOPS-NEXT:    ldr q0, [x16, :lo12:.LCPI0_0]
; CHECK-MOPS-NEXT:    adrp x10, .LCPI0_1
; CHECK-MOPS-NEXT:    setp [x9]!, x8!, xzr
; CHECK-MOPS-NEXT:    setm [x9]!, x8!, xzr
; CHECK-MOPS-NEXT:    sete [x9]!, x8!, xzr
; CHECK-MOPS-NEXT:    mov w11, #6424 // =0x1918
; CHECK-MOPS-NEXT:    mov w8, #7452 // =0x1d1c
; CHECK-MOPS-NEXT:    ldr d1, [x10, :lo12:.LCPI0_1]
; CHECK-MOPS-NEXT:    movk w11, #6938, lsl #16
; CHECK-MOPS-NEXT:    strh w8, [sp, #1036]
; CHECK-MOPS-NEXT:    mov w8, #30 // =0x1e
; CHECK-MOPS-NEXT:    add x0, sp, #1008
; CHECK-MOPS-NEXT:    add x1, sp, #8
; CHECK-MOPS-NEXT:    str w11, [sp, #1032]
