...
; CHECK-NEXT:    ldr q3, [x16, :lo12:.LCPI0_2]
; CHECK-NEXT:    cmhi v1.2d, v2.2d, v1.2d
; CHECK-NEXT:    adrp x16, .LCPI0_3
; CHECK-NEXT:    ldr q4, [x16, :lo12:.LCPI0_3]
; CHECK-NEXT:    cmhi v3.2d, v2.2d, v3.2d
; CHECK-NEXT:    adrp x16, .LCPI0_4
; CHECK-NEXT:    uzp1 v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    ldr q5, [x16, :lo12:.LCPI0_4]
; CHECK-NEXT:    cmhi v4.2d, v2.2d, v4.2d
; CHECK-NEXT:    adrp x16, .LCPI0_5
; CHECK-NEXT:    ldr q6, [x16, :lo12:.LCPI0_5]
; CHECK-NEXT:    cmhi v5.2d, v2.2d, v5.2d
; CHECK-NEXT:    adrp x16, .LCPI0_6
; CHECK-NEXT:    uzp1 v1.4s, v4.4s, v3.4s
; CHECK-NEXT:    ldr q7, [x16, :lo12:.LCPI0_6]
; CHECK-NEXT:    cmhi v6.2d, v2.2d, v6.2d
; CHECK-NEXT:    adrp x16, .LCPI0_7
; CHECK-NEXT:    ldr q16, [x16, :lo12:.LCPI0_7]
