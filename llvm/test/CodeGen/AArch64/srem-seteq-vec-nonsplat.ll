...
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI0_1]
; CHECK-NEXT:    adrp x16, .LCPI0_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI0_2]
; CHECK-NEXT:    adrp x16, .LCPI0_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI0_3]
; CHECK-NEXT:    adrp x16, .LCPI0_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI0_4]
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    adrp x16, .LCPI5_0
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI5_0]
; CHECK-NEXT:    adrp x16, .LCPI5_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI5_1]
; CHECK-NEXT:    adrp x16, .LCPI5_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI5_2]
; CHECK-NEXT:    adrp x16, .LCPI5_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI5_3]
; CHECK-NEXT:    adrp x16, .LCPI5_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI5_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    adrp x16, .LCPI6_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI6_1]
; CHECK-NEXT:    adrp x16, .LCPI6_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI6_2]
; CHECK-NEXT:    adrp x16, .LCPI6_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI6_3]
; CHECK-NEXT:    adrp x16, .LCPI6_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI6_4]
; CHECK-NEXT:    cmhi v0.4s, v0.4s, v1.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
  %srem = srem <4 x i32> %X, <i32 5, i32 14, i32 4294967295, i32 100>
...
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI7_0]
; CHECK-NEXT:    adrp x16, .LCPI7_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI7_1]
; CHECK-NEXT:    adrp x16, .LCPI7_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI7_2]
; CHECK-NEXT:    adrp x16, .LCPI7_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI7_3]
; CHECK-NEXT:    adrp x16, .LCPI7_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI7_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI8_0]
; CHECK-NEXT:    adrp x16, .LCPI8_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI8_1]
; CHECK-NEXT:    adrp x16, .LCPI8_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI8_2]
; CHECK-NEXT:    adrp x16, .LCPI8_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI8_3]
; CHECK-NEXT:    adrp x16, .LCPI8_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI8_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    adrp x16, .LCPI9_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI9_1]
; CHECK-NEXT:    adrp x16, .LCPI9_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI9_2]
; CHECK-NEXT:    adrp x16, .LCPI9_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI9_3]
; CHECK-NEXT:    adrp x16, .LCPI9_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI9_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    fneg v1.4s, v1.4s
; CHECK-NEXT:    mla v1.4s, v0.4s, v2.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI10_0]
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    cmhs v0.4s, v0.4s, v1.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    dup v2.4s, w9
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI11_0]
; CHECK-NEXT:    shl v0.4s, v2.4s, #31
; CHECK-NEXT:    usra v0.4s, v2.4s, #1
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
...
; CHECK-NEXT:    adrp x16, .LCPI12_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI12_1]
; CHECK-NEXT:    adrp x16, .LCPI12_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI12_2]
; CHECK-NEXT:    adrp x16, .LCPI12_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI12_3]
; CHECK-NEXT:    adrp x16, .LCPI12_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI12_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI13_0]
; CHECK-NEXT:    adrp x16, .LCPI13_1
; CHECK-NEXT:    smull2 v2.2d, v0.4s, v1.4s
; CHECK-NEXT:    smull v1.2d, v0.2s, v1.2s
; CHECK-NEXT:    uzp2 v1.4s, v1.4s, v2.4s
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI13_1]
; CHECK-NEXT:    adrp x16, .LCPI13_2
; CHECK-NEXT:    mla v1.4s, v0.4s, v2.4s
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI13_2]
; CHECK-NEXT:    adrp x16, .LCPI13_3
; CHECK-NEXT:    sshl v2.4s, v1.4s, v2.4s
; CHECK-NEXT:    usra v2.4s, v1.4s, #31
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI13_3]
...
; CHECK-NEXT:    adrp x16, .LCPI14_1
; CHECK-NEXT:    smull2 v2.2d, v0.4s, v1.4s
; CHECK-NEXT:    smull v1.2d, v0.2s, v1.2s
; CHECK-NEXT:    uzp2 v1.4s, v1.4s, v2.4s
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI14_1]
; CHECK-NEXT:    adrp x16, .LCPI14_2
; CHECK-NEXT:    mla v1.4s, v0.4s, v2.4s
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI14_2]
; CHECK-NEXT:    adrp x16, .LCPI14_3
; CHECK-NEXT:    sshl v2.4s, v1.4s, v2.4s
; CHECK-NEXT:    usra v2.4s, v1.4s, #31
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI14_3]
; CHECK-NEXT:    mls v0.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v1.4s, #1
; CHECK-NEXT:    cmeq v0.4s, v0.4s, #0
; CHECK-NEXT:    and v0.16b, v0.16b, v1.16b
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    adrp x16, .LCPI15_0
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI15_0]
; CHECK-NEXT:    adrp x16, .LCPI15_1
; CHECK-NEXT:    smull2 v2.2d, v0.4s, v1.4s
; CHECK-NEXT:    smull v1.2d, v0.2s, v1.2s
; CHECK-NEXT:    uzp2 v1.4s, v1.4s, v2.4s
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI15_1]
; CHECK-NEXT:    adrp x16, .LCPI15_2
; CHECK-NEXT:    mla v1.4s, v0.4s, v2.4s
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI15_2]
; CHECK-NEXT:    adrp x16, .LCPI15_3
; CHECK-NEXT:    sshl v2.4s, v1.4s, v2.4s
; CHECK-NEXT:    usra v2.4s, v1.4s, #31
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI15_3]
; CHECK-NEXT:    mls v0.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v1.4s, #1
; CHECK-NEXT:    cmeq v0.4s, v0.4s, #0
; CHECK-NEXT:    and v0.16b, v0.16b, v1.16b
...
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI16_1]
; CHECK-NEXT:    adrp x16, .LCPI16_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI16_2]
; CHECK-NEXT:    adrp x16, .LCPI16_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI16_3]
; CHECK-NEXT:    adrp x16, .LCPI16_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI16_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI17_1]
; CHECK-NEXT:    adrp x16, .LCPI17_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI17_2]
; CHECK-NEXT:    adrp x16, .LCPI17_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI17_3]
; CHECK-NEXT:    adrp x16, .LCPI17_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI17_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI18_1]
; CHECK-NEXT:    adrp x16, .LCPI18_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI18_2]
; CHECK-NEXT:    adrp x16, .LCPI18_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI18_3]
; CHECK-NEXT:    adrp x16, .LCPI18_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI18_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    mov w8, #28087 // =0x6db7
; CHECK-NEXT:    mov w9, #9362 // =0x2492
; CHECK-NEXT:    adrp x16, .LCPI20_0
; CHECK-NEXT:    movk w8, #46811, lsl #16
; CHECK-NEXT:    movk w9, #4681, lsl #16
; CHECK-NEXT:    dup v1.4s, w8
; CHECK-NEXT:    dup v2.4s, w9
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI20_0]
; CHECK-NEXT:    shl v0.4s, v2.4s, #31
; CHECK-NEXT:    usra v0.4s, v2.4s, #1
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
...
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI21_0]
; CHECK-NEXT:    adrp x16, .LCPI21_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI21_1]
; CHECK-NEXT:    adrp x16, .LCPI21_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI21_2]
; CHECK-NEXT:    adrp x16, .LCPI21_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI21_3]
; CHECK-NEXT:    adrp x16, .LCPI21_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI21_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    adrp x16, .LCPI22_0
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI22_0]
; CHECK-NEXT:    adrp x16, .LCPI22_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI22_1]
; CHECK-NEXT:    adrp x16, .LCPI22_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI22_2]
; CHECK-NEXT:    adrp x16, .LCPI22_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI22_3]
; CHECK-NEXT:    adrp x16, .LCPI22_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI22_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    adrp x16, .LCPI23_0
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI23_0]
; CHECK-NEXT:    adrp x16, .LCPI23_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI23_1]
; CHECK-NEXT:    adrp x16, .LCPI23_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI23_2]
; CHECK-NEXT:    adrp x16, .LCPI23_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI23_3]
; CHECK-NEXT:    adrp x16, .LCPI23_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI23_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    adrp x16, .LCPI24_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI24_1]
; CHECK-NEXT:    adrp x16, .LCPI24_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI24_2]
; CHECK-NEXT:    adrp x16, .LCPI24_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI24_3]
; CHECK-NEXT:    adrp x16, .LCPI24_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI24_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    adrp x16, .LCPI25_0
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI25_0]
; CHECK-NEXT:    adrp x16, .LCPI25_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI25_1]
; CHECK-NEXT:    adrp x16, .LCPI25_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI25_2]
; CHECK-NEXT:    adrp x16, .LCPI25_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI25_3]
; CHECK-NEXT:    adrp x16, .LCPI25_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI25_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
...
; CHECK:       // %bb.0:
; CHECK-NEXT:    adrp x16, .LCPI26_0
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI26_0]
; CHECK-NEXT:    adrp x16, .LCPI26_1
; CHECK-NEXT:    ldr q2, [x16, :lo12:.LCPI26_1]
; CHECK-NEXT:    adrp x16, .LCPI26_2
; CHECK-NEXT:    mla v2.4s, v0.4s, v1.4s
; CHECK-NEXT:    ldr q0, [x16, :lo12:.LCPI26_2]
; CHECK-NEXT:    adrp x16, .LCPI26_3
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI26_3]
; CHECK-NEXT:    adrp x16, .LCPI26_4
; CHECK-NEXT:    ushl v0.4s, v2.4s, v0.4s
; CHECK-NEXT:    ushl v1.4s, v2.4s, v1.4s
; CHECK-NEXT:    movi v2.4s, #1
; CHECK-NEXT:    orr v0.16b, v1.16b, v0.16b
; CHECK-NEXT:    ldr q1, [x16, :lo12:.LCPI26_4]
; CHECK-NEXT:    cmhs v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    and v0.16b, v0.16b, v2.16b
; CHECK-NEXT:    ret
